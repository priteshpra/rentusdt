                                ...
                                <nav id="main-nav" class="main-nav">
                                    <ul id="menu-primary-menu" class="menu">
                                        ...
                                        <li class="menu-item-has-children">
                                            <a href="https://rentusdt.com/#how">How It Works</a>
                                        </li>
                                        <li class="menu-item">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="block-text center">
                        <h3 class="heading">Register To RENT'USDT</h3>
                        <p class="desc fs-20">
                                ...
                                <form method="POST" action="{{ route('register') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="email" value="{{ old('email') }}" class="form-control"
                                            id="exampleInputEmail1" placeholder="Please fill in the email form." />
                                    </div>
                                    <div class="form-group">
                                        <label>Password
    ...
    <footer class="footer style-2">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-md-12">
                        <div class="footer-contact">
                            <h5>Newletters</h5>
                            <p>
                                Subscribe our newsletter to get Our letest Updates
                            </p>
                            <form action="#">
        ...
        <div class="container-fluid">
            <div class="footer__bottom">
                <p>
                    ©2025 rentusdt.com. All rights reserved. Terms of Service | Privacy
                    Terms
                </p>
            </div>
        </div>
