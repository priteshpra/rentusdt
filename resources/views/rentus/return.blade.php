                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="{{ !empty($retrn->user) && !empty($retrn->user->avatar) ? asset('storage/'.$retrn->user->avatar) : asset('rentus/assets/images/users/avatar-1.jpg') }}" height="40" class="me-2 rounded" alt="">
