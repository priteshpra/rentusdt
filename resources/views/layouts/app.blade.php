...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="{{ asset('rentus/assets/images/favicon.ico') }}" />

    <!-- CSS -->
    <link href="{{ asset('rentus/assets/css/bootstrap.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('rentus/assets/css/icons.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('rentus/assets/css/app.min.css') }}" rel="stylesheet" />
    @stack('styles')
</head>

<body>
    {{-- Include Header --}}
    @include('rentus.header')
