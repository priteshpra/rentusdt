                ...
                <div class="col-md-6">
                    <div class="card bg-globe-img">
                        <div class="card-body">
                            ...
                            <h4 class="my-2 fs-24 fw-semibold">$ 1120 <small class="font-14">USDT</small></h4>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('rentus/assets/images/logos/lang-logo/chatgpt.png') }}" height="40" class="me-3 rounded">
                                            <div>
                                    ...
                                    <td>20 July 2024</td>
                                    <td>$560</td>
                                    <td><span class="badge bg-success-subtle text-success fs-11 fw-medium px-2">Successful</span></td>
                                    <td>
