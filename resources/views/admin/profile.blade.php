    ...
    <div class="col-md-4">
            ...
            <div class="card-body mt-n6">
                <div class="d-flex align-items-center mb-3">
                    <div class="position-relative">
                        <img src="{{ !empty($user->avatar) ? asset('storage/'.$user->avatar) : asset('rentus/assets/images/users/avatar-5.jpg') }}"
        ...
        <div class="card mt-3">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('admin.profile.edit') }}" class="text-muted text-decoration-underline">
